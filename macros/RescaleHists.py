...
if era == "2018":
    #samples = ['SUSY_2018', 'DYJetsToLL_2018', 'WZTo3LNu_2018', 'ZZTo4L_2018', 'ZZ_2018', 'WZ_2018', 'WW_2018', 'WJetsToLNu_2018', 'TTJets_2018','QCD_2018']
    ...
    samples = ['SUSY_2018', 'DYJetsToLL_2018',  'ZZ_2018', 'WZ_2018', 'WJetsToLNu_2018', 'TTJets_2018','QCD_BGen_2018','WW_2018']
    #samples=['QCD_BGen_2018','WW_2018']
def RescaleHist_Skimmed(samp_mass):
    ...
    os.popen("dos2unix /uscms_data/d3/nbower/FSU/HtoAA/Analyzer/CMSSW_10_6_26/src/higgstoaaAnalyzer/higgstoaaAnalyzer/macros/HaddByBin.sh")
    os.popen('/uscms_data/d3/nbower/FSU/HtoAA/Analyzer/CMSSW_10_6_26/src/higgstoaaAnalyzer/higgstoaaAnalyzer/macros/HaddByBin.sh '+samp_mass+ ' '+label+' '+"1" )
    #build A dictionary with all files mapped to their given ptbin
    filedir="/uscms_data/d3/nbower/FSU/HtoAA/Analyzer/CMSSW_10_6_26/src/higgstoaaAnalyzer/higgstoaaAnalyzer/HaddFolder/"
    ...
    for ptbin in xsecs_dict:
        ...
        firstFile=False
    OutFile =ROOT.TFile( '/uscms_data/d3/nbower/FSU/HtoAA/Analyzer/CMSSW_10_6_26/src/higgstoaaAnalyzer/higgstoaaAnalyzer/plots/'+label+'.root',"RECREATE")
    for histname in OutHists:
        OutHists[histname].Write()
    OutFile.Close()
    os.popen("rm -rf /uscms_data/d3/nbower/FSU/HtoAA/Analyzer/CMSSW_10_6_26/src/higgstoaaAnalyzer/higgstoaaAnalyzer/HaddFolder/*")
    os.popen("rm -rf /uscms_data/d3/nbower/FSU/HtoAA/Analyzer/CMSSW_10_6_26/src/higgstoaaAnalyzer/higgstoaaAnalyzer/HaddFolder")
...
def RescaleHist_WholeMilk(samp_mass):
    ...
    label=analysislabel+"_"+samp_mass
    os.popen("dos2unix /uscms_data/d3/nbower/FSU/HtoAA/Analyzer/CMSSW_10_6_26/src/higgstoaaAnalyzer/higgstoaaAnalyzer/macros/HaddByBin.sh")
    os.popen('/uscms_data/d3/nbower/FSU/HtoAA/Analyzer/CMSSW_10_6_26/src/higgstoaaAnalyzer/higgstoaaAnalyzer/macros/HaddByBin.sh '+samp_mass+ ' '+label+" 0" )
    #build A dictionary with all files mapped to their given ptbin
    filedir="/uscms_data/d3/nbower/FSU/HtoAA/Analyzer/CMSSW_10_6_26/src/higgstoaaAnalyzer/higgstoaaAnalyzer/HaddFolder/"
    #build a list of histograms and thier associated types
    OutHists={}
...
def RescaleHist_18(samp_mass):
    ...
    print ("test")
    os.popen("dos2unix /uscms_data/d3/nbower/FSU/HtoAA/Analyzer/CMSSW_10_6_26/src/higgstoaaAnalyzer/higgstoaaAnalyzer/macros/HaddByBin.sh")
    os.popen('/uscms_data/d3/nbower/FSU/HtoAA/Analyzer/CMSSW_10_6_26/src/higgstoaaAnalyzer/higgstoaaAnalyzer/macros/HaddByBin.sh '+samp_mass+ ' '+label+" 0 2018" )
    #build A dictionary with all files mapped to their given ptbin
    filedir="/uscms_data/d3/nbower/FSU/HtoAA/Analyzer/CMSSW_10_6_26/src/higgstoaaAnalyzer/higgstoaaAnalyzer/HaddFolder/"
    #build a list of histograms and thier associated types
    OutHists={}
